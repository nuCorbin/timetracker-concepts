      ...
      <header className="bg-primary text-primary-foreground p-4 flex justify-between items-center">
        <div className="flex items-center">
          <div className="flex items-center">
            ...
            <span className="text-primary-foreground text-xl font-semibold mt-0.5">SSIS v1</span>
          </div>
        </div>
              ...
              <Dialog open={allocateDialogOpen} onOpenChange={setAllocateDialogOpen}>
                <DialogContent className="sm:max-w-[600px]">
                        ...
                        <table className="w-full">
                          ...
                          <tbody>
                            {selectedPeople.filter(person => person.checked).map((person) => (
                              <tr key={person.name} className="border-b bg-accent ${person.checked ? 'bg-accent' : ''}">
                  ...
                  <DialogFooter className="flex justify-end space-x-2">
                    ...
                    <Button className="bg-[#005599] hover:bg-primary/90 text-primary-foreground" onClick={() => setAllocateDialogOpen(false)}>
                      OK
                    </Button>
                  </DialogFooter>
                </DialogContent>
